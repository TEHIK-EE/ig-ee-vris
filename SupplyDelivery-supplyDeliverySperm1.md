...
| :--- | :--- | :--- |
| - | **Quantity** | **Item[x]** |
| * | 4 doosi | [BiologicallyDerivedProduct: extension = 2025-02-20,->Leena Lööve (official) Female, DoB: 1983-01-11 ( https://fhir.ee/sid/pid/est/ni#38301105216); productCode = Seemnerakud; biologicalSourceEvent = ABC123; productStatus = available (available)](BiologicallyDerivedProduct-sperm1.md) |
