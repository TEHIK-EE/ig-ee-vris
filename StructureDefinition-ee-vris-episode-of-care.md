...
| Draft as of 2026-09-25 | *Computable Name*:EEVRISEpisodeOfCare |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "(ee Siin on episoodi staatus, kohustuslik! planned | waitlist | active | onhold | finished | cancelled | entered-in-error)"
    },
    {
      "id" : "EpisodeOfCare.type",
      "path" : "EpisodeOfCare.type",
      "short" : "(ee Episoodi tüüp, nt viljatusRAVI, rasedus, ANNETAMINE, viljakuse säilitamine. NB! Vaja LOENDIT!)"
    },
    {
