...
| Draft as of 2026-09-25 | *Computable Name*:EEVRISProcedureCryopreservation |
...
* Refer to this Profile: [Procedure: EE VRIS Allocation](StructureDefinition-ee-vris-procedure-allocation.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "(ee Külmutamise põhjus, donatsioon, iseendale säilitamine, mittesiirdamiseks vms (NB! LOEND puudu!))",
      "binding" : {
        "strength" : "preferred",
