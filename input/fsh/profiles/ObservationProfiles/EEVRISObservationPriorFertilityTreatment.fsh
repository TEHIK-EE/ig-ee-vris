...
* code 1..1
//* code = $vris-anamnesis-code-CS#prior-fertility-treatment
* code ^short = "(ee Varasem viljatusravi. Vaja LOENDIT või kasutame LOINC?)"
* subject 1..1
...
* component ^slicing.description = "Varasema viljatusravi komponendid"
* component contains
    priorIVF 0..1 and
...
* component[priorIVF].code = $fertility-treatment-component-CS#prior-ivf
...
* component[ivfCyclesCount].code ^short = "IVF cycles count"
...
* component[priorIUI].code ^short = "Prior IUI performed"
...
* component[iuiCyclesCount].code ^short = "IUI cycles count"
