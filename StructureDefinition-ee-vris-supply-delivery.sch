...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:SupplyDelivery">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vris/StructureDefinition/ee-vris-supplied-package']) &lt;= 1">extension with URL = 'https://fhir.ee/vris/StructureDefinition/ee-vris-supplied-package': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:supplier) &gt;= 1">supplier: minimum cardinality of 'supplier' is 1</sch:assert>
