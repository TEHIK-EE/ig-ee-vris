...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:BiologicallyDerivedProduct">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vris/StructureDefinition/ee-vris-package']) &lt;= 1">extension with URL = 'https://fhir.ee/vris/StructureDefinition/ee-vris-package': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:productCategory) &lt;= 0">productCategory: maximum cardinality of 'productCategory' is 0</sch:assert>
      ...
      <sch:assert test="count(f:processingFacility) &lt;= 1">processingFacility: maximum cardinality of 'processingFacility' is 1</sch:assert>
