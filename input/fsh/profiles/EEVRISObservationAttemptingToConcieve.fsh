...
Description: "Observation profile for recording when/how long is woman attempting to concieve. (ee Rasesduda üritamine.)"
* ^status = #draft
* ^experimental = false
* ^version = "0.1.0"
...
* encounter 0..0
* effective[x] 0..1
* effective[x] ^short = "Anamneesi kogumise kuupäev"
* issued 0..1
* issued ^short = "Süsteemi sisestamise kuupäev/kellaaeg"
* performer 0..*
* performer ^short = "Kes salvestas"
