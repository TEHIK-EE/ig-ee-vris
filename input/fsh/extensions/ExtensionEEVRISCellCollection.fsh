...
Description: "Extension for recording cell collection method. (ee Suguraku (sperma) kogumise meetod.|Munarakkude viljastamise päeval annetatud|,|Külmutatud-sulatatud|,|Inseminatsiooni päeval annetatud ja varasemalt külmutatud-sulatatud seemnerakkude koos kasutamine|)"
