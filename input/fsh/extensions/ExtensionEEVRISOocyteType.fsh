...
Title: "Oocyte origin"
Description: "Extension for recording oocyte type. (ee Munaraku tüüp.|Viljastamise päeval hangitud|,|Külmutatud-sulatatud|Viljastamise päeval hangitud ja külmutatud-sulatatud|)"
