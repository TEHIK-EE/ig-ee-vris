...
Title: "EE VRIS DonorPhysical Appearance Observation"
Description: "Observation profile for recording characteristics of physical appearance of a donor in the Estonian VRIS fertility system."
* ^status = #active
* ^experimental = false
* ^version = "1.0.0"
* status = #final
