...
| Draft as of 2026-09-09 | *Computable Name*:EEVRISObservationPhysicalAppearance |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.component:eyecolorDetail",
      "path" : "Observation.component",
      "sliceName" : "eyecolorDetail",
      "short" : "Silmade värvuse täpsustus. Hele/tume. LOEND VAJA!",
      "min" : 0,
      "max" : "1"
    },
    {
      "id" : "Observation.component:eyecolorDetail.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "http://snomed.info/sct",
    ...
    {
      "id" : "Observation.component:eyecolorDetail.value[x]",
      "path" : "Observation.component.value[x]",
      "min" : 1,
      "type" : [{
        "code" : "CodeableConcept"
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://fhir.ee/ValueSet/vris-silmade-varvuse-tapsustus"
      }
    },
    {
