...
> **property****type**: preservation-reason**value**: |Oncologic (qualifier value)|

> **property****type**: preservation-method**value**: Kirurgiliselt saadud seemnerakkude säilitamine
  ...
  },
  {
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        "system" : "http://snomed.info/sct",
        "code" : "3428006",
        "display" : "|Oncologic (qualifier value)|"
      }]
    }
  },
  {
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        "system" : "http://snomed.info/sct",
        "code" : "TODO",
        "display" : "Kirurgiliselt saadud seemnerakkude säilitamine"
      }]
    }
  }]
}
