...
| Draft as of 2026-09-25 | *Computable Name*:EEVRISProcedureDestruction |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Procedure.code",
      "path" : "Procedure.code",
      "short" : "(ee KAS siin on codde vaja või piisab ainult categoryst?!?! Hävitamise täpsem kood (nt munaraku hävitamine jne). NB! LOEND puudu!)",
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://fhir.ee/ValueSet/vris-havitamine"
      }
    },
    {
