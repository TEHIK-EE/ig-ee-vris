...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vris/StructureDefinition/ee-vris-role']) &lt;= 1">extension with URL = 'https://fhir.ee/vris/StructureDefinition/ee-vris-role': maximum cardinality of 'extension' is 1</sch:assert>
