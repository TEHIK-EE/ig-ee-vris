...
| Draft as of 2026-09-25 | *Computable Name*:ExtensionEEVRISThawing |
...
* Examples for this Extension: [BiologicallyDerivedProduct/oocyte1-3](BiologicallyDerivedProduct-oocyte1-3.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "When thawing or warming is happening",
      "min" : 0,
      "max" : "1"
    },
    {
