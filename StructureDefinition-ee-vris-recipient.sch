...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile EEMPIPatientVerified
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vris/StructureDefinition/ee-vris-birth-sex']) &lt;= 1">extension with URL = 'https://fhir.ee/vris/StructureDefinition/ee-vris-birth-sex': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/base/StructureDefinition/ee-patient-age']) &lt;= 1">extension with URL = 'https://fhir.ee/base/StructureDefinition/ee-patient-age': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/base/StructureDefinition/ee-date-accuracy-indicator']) &lt;= 1">extension with URL = 'https://fhir.ee/base/StructureDefinition/ee-date-accuracy-indicator': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
