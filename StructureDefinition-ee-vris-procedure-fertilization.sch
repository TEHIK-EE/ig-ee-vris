...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile EEVRISProcedure
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="count(f:used) &gt;= 1">used: minimum cardinality of 'used' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
