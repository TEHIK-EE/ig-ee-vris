...
* activity[0].performedActivity[procedure].reference = Reference(Procedure/procedure-oocyte-retrieval1)
* activity[+].performedActivity[procedure].reference = Reference(Procedure/procedure-fertilization1)
* activity[+].performedActivity[procedure].reference = Reference(Procedure/procedure-embryo-transfer1)
